...
contract ReferenceTable is OwnableUpgradeable {
    ...
    function __ReferenceTable_init() public initializer {
     ...
     */
    function getReferenceByAddress(address _address)
        public
        view
        onlyOwner
     ...
     */
    function getAddressByReference(string memory _reference)
        public
        view
        onlyOwner
        returns (address)
