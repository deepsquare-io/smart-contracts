...
export interface RewardProgramInterface extends utils.Interface {
  functions: {
    "DPS()": FunctionFragment;
    "STC()": FunctionFragment;
    "close()": FunctionFragment;
    "convertDPStoSTC(uint256)": FunctionFragment;
    "deliverDPS(uint256,address,address)": FunctionFragment;
  ...
  events: {
    ...
    "Reward(address,address,uint256)": EventFragment;
  };
...
export interface RewardProgram extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RewardProgramInterface;
  ...
  filters: {
    ...
    "Reward(address,address,uint256)"(
      bucket?: string | null,
