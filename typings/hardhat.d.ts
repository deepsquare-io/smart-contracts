...
declare module 'hardhat/types/runtime' {
  interface HardhatEthersHelpers extends HardhatEthersHelpersBase {
    ...
    getContractAt(name: 'Bridge', address: string, signer?: ethers.Signer): Promise<Contracts.Bridge>;
    ...
    getContractAt(name: 'Sale', address: string, signer?: ethers.Signer): Promise<Contracts.Sale>;
    getContractAt(name: 'Square', address: string, signer?: ethers.Signer): Promise<Contracts.Square>;
